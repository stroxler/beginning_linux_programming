-- clear tables (actually schema.sql drops them and re-adds them anyway)
delete from track;
delete from cd;
delete from artist;
...
values
    ...
    (2, 'Wish You Were Here', 1, 'B000024D4P'),
    (3, 'A trick of the Tail', 2, 'B000024D4P'),
    (4, 'Selling England By the Pound', 2, 'B000024D4P'),
    (5, 'I Giorni', 3, 'B000024D4P'),
    (6, 'Northern Star', 4, 'B000024D4P');
